...
const Footer = () => {
  const brandImages = [
    {
      ...
      alt: 'Brand Logo 1',
      className:
        'self-stretch my-auto aspect-[1.02] fill-neutral-300 w-[50px]  hover:scale-110 transition-all',
  ...
  return (
    <Reveal movementY={60} movementX={0} duration={0.4}>
      <div className='flex flex-col items-center px-16 pt-8 max-md:px-5'>
