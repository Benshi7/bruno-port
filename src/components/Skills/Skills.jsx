...
const Skills = () => {
  return (
    <div className="flex flex-col sm:flex-row">
      ...
      <div className='py-6 xl:py-36 lg:py-24 pb-8'>
        <Reveal movementY={70}>
          <Services/>
        </Reveal>
        </div>
      ...
      <div className="w-full sm:w-1/2 p-4 py-0 text-left order-1">
        <div className="h-[rem] rounded-md flex flex-col antialiaseddark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden">
          ...
          <h2 className="text-5xl text-right ml-[20rem] text-slate-200 font-semibold mt-12 xl:text-7xl lg:text-6xl xl:mr-[40rem] xl:text-left">SKILLS</h2>
          </Reveal>
        </div>
